...
if (class_exists('mkmatrix_sku')) {
	return;
}

class mkmatrix_sku extends \CModule
{
	public function __construct()
	{
		$this->MODULE_ID = "mkmatrix.sku";

		$this->MODULE_VERSION = '1.0.0';
		$this->MODULE_VERSION_DATE = '2023-06-27 11:38:00';

		$this->MODULE_NAME = 'МК: создание предложений из товаров';
		$this->MODULE_DESCRIPTION = 'Перенос товара в торговые предложения по свойству';
